...
class BaseTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.aerosolve_data = dict({"nOfPeople": 2, "sr_age_factor": 0.68, "sr_strain_factor": 1, "pim": 0.45,
                                    "floor_area": 910, "exp_time": 100, "mean_ceiling_height": 12,
                                    "air_exchange_rate": 3,
                                    "recirc_rate": 1, "exhaled_air_inf": 2.04, "def_aerosol_radius": 2, "merv": 6,
                                    "breathing_flow_rate": 0.29,
                                    "risk_tolerance": 0.1, "mask_eff": 0.90, "mask_fit": 0.95,
                                    "max_viral_deact_rate": 0.60, "relative_humidity": 0.6
                                    })
    ...
    def test_country_vaccine_stats(self):
        res = self.client().post('/country_vaccine_stats', data=json.dumps(self.country),
